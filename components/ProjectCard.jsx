...
export default function ProjectCard({ project, className }) {
  return (
    <Card
      className={`group overflow-hidden relative hover:shadow-primary shadow-2xl h-[480px]`}
    >
      <CardHeader className="p-0">
        <div
          className="relative w-full h-[300px] flex items-center justify-center bg-tertiary dark:bg-secondary/40 xl:bg-work_project_bg_light
        xl:dark:bg-work_project_bg_dark xl:bg-[110%] xl:bg-no-repeat overflow-hidden"
        >
          <Image
            className="absolute bottom-2 shadow-2xl"
            src={project.image}
            alt=""
            fill
